...
face_cascade = cv2.CascadeClassifier('D://Project//gesture-updated code//gesture-updated code//haarcascade_frontalface_default.xml')

eye_cascade = cv2.CascadeClassifier('D://Project//gesture-updated code//gesture-updated code/haarcascade_eye.xml')
