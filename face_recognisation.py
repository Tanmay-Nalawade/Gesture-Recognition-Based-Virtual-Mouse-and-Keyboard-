...
faces=cv2.CascadeClassifier('D:/gesture-updated code/haarcascade_frontalface_default.xml')

# to detect the eyes
eyes=cv2.CascadeClassifier('D:/gesture-updated code/haarcascade_eye.xml')
